...
import { Table, Button, Pagination, Container, Modal, Form, Row, Col, FormControl, Badge } from 'react-bootstrap';
  ...
  return (
    <Container className=" p-3 bg-white shadow-sm text-center">
      ...
      <div className="d-flex flex-row justify-content-between">
        ...
        {indexOfLastUser > usersData.length
          ? usersData.length
          : indexOfLastUser}{" "}
      ...
      <Button className="px-4" onClick={handleShowAddUserModal}>
        Add user
      </Button>
    </Container>
  );
